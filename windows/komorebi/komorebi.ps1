...
komorebic ensure-named-workspaces 0 L1 l2

# Create named workspaces I-V on monitor 0
komorebic ensure-named-workspaces 1 R1 R2
...
komorebic named-workspace-layout L1 bsp

komorebic named-workspace-padding L1 4
komorebic named-workspace-container-padding L1 4

komorebic named-workspace-layout R1 bsp

komorebic named-workspace-padding R1 4
komorebic named-workspace-container-padding R1 4
